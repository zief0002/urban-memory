...
$$
In this situation, **X** is not of full rank, and the $\mathbf{X}^{\intercal}\mathbf{X}$ matrix is singular. In this situation, the OLS normal equations do not have a unique solution. 
...
The design matrix below is not of full rank, because any one of the columns is a linear combination of the

It is more likely, in practice, that you will have less-than-perfect collinearity, and that this will have an adverse effect on the computational estimates of the coefficients' sampling variances. To understand why this is the case, 


When this happens, the , and 


Recall that the sampling variance for a predictor, $B_j$ is
...
In practice it is rare to have exact collinearity. 
