...
The data set you will use to answer the questions in this assignment (*stack-1979.csv*) contains measurements for 18 countries on: income inequality (`inequality`), democratic experience (`turnout`), economic development (`energy`), and socialist party strength (`socialist`). Specifically, the variables in the data set are:
